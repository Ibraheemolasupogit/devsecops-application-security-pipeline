# Threat-Model Review With Assets, Actors, Entry Points, Trust Boundaries, Abuse Cases And Requirement Gaps

Use this template to capture threat-model review with assets, actors, entry points, trust boundaries, abuse cases and requirement gaps. Keep entries role-based and evidence-backed. Required fields: date, squad, champion role, evidence references, decisions needed, actions, owners, due dates, and escalation status. Do not include personal data, email addresses, raw secrets, JWTs, or unsupported attendance claims.
