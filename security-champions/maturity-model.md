...
The maturity model uses Level 0 - Ad hoc, Level 1 - Aware, Level 2 - Repeatable, Level 3 - Measured, and Level 4 - Embedded. Areas include threat modelling, secure code review, local checks, finding ownership, remediation, verification, exception governance, evidence, and learning.
...
The model deliberately avoids a single opaque score. Each area has evidence and a next step.
