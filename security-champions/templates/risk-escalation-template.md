# Risk Escalation With Trigger, Evidence, Affected Control, Owner, Due Date, Release Impact And Proposed Decision

Use this template to capture risk escalation with trigger, evidence, affected control, owner, due date, release impact and proposed decision. Keep entries role-based and evidence-backed. Required fields: date, squad, champion role, evidence references, decisions needed, actions, owners, due dates, and escalation status. Do not include personal data, email addresses, raw secrets, JWTs, or unsupported attendance claims.
