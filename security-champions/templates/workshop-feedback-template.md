# Workshop Feedback With Learning Objective, Exercise Result, Evidence Confidence And Improvement Idea

Use this template to capture workshop feedback with learning objective, exercise result, evidence confidence and improvement idea. Keep entries role-based and evidence-backed. Required fields: date, squad, champion role, evidence references, decisions needed, actions, owners, due dates, and escalation status. Do not include personal data, email addresses, raw secrets, JWTs, or unsupported attendance claims.
