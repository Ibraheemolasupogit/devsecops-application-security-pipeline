# Champion Handover With Squad Context, Current Findings, Exceptions, Recurring Weaknesses And Next Sessions

Use this template to capture champion handover with squad context, current findings, exceptions, recurring weaknesses and next sessions. Keep entries role-based and evidence-backed. Required fields: date, squad, champion role, evidence references, decisions needed, actions, owners, due dates, and escalation status. Do not include personal data, email addresses, raw secrets, JWTs, or unsupported attendance claims.
