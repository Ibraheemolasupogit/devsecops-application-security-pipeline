...
A champion promotes secure design, supports lightweight threat modelling, encourages local checks, helps interpret scanner results, supports remediation, identifies recurring weaknesses, shares reusable patterns, escalates unresolved risk, supports secure code review, and keeps squad security knowledge current.

Champions are not formal risk acceptors, production incident owners, central security-tool owners, legal approvers, penetration testers, or sole security approvers. They should be close enough to delivery to help quickly and disciplined enough to preserve Product Security accountability.
